...
public class AuthController : ControllerBase
{
    ...
    /// <summary>
    /// Získání uživatelských dat přihlášeného uživatele na základě http kontextu
    /// </summary>
    [Produces("application/json")]
    [HttpGet("user")]
    [AllowAnonymous]
    ...
    /// <summary>
    /// Aktualizuje přístupový token, pro desktopové nebo mobilní aplikace
    /// </summary>
    [Produces("application/json")]
    ...
    /// <summary>
    /// Dokončení registrace na webové stránce, pouze pro neregistrované uživatele
    /// </summary>
    [Consumes("application/json")]
